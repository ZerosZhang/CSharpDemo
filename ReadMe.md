...
- **单个 Demo**：`dotnet run --project src/<Demo>`
  - 例：`dotnet run --project src/ValidateDemo`
...
[查看详细说明](src/DigitalTubeDemo/README.md)
...
[查看详细说明](src/ValidateDemo/README.md)
